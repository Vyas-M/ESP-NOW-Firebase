...
void setup() {
  ...
  message.sender.name = "ESP32_RECIEVER";
  message.sender.email = AUTHOR_EMAIL;
  message.subject = "ESP Device turn on Notification";
  message.addRecipient("Vyas", RECIPIENT_EMAIL);

  
  //Send raw text message
  String textMsg = "Hello, your device has been turned on!";
